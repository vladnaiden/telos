...
class GUMP
{
	...
	public function get_readable_errors($convert_to_string = false, $field_class="field", $error_class="error-message")
	{
		...
		foreach($this->errors as $e) {
			...
			switch($e['rule']) {
				case 'mismatch' :
					$resp[] = "Правило проверки для поля <span class=\"$field_class\">$field</span> отсутствует";
					break;
				case 'validate_required':
					$resp[] = "Поле <span class=\"$field_class\">$field</span> обязательно для заполнения";
					break;
				case 'validate_valid_email':
					$resp[] = "Введите в поле <span class=\"$field_class\">$field</span> правильный адрес Email";
					break;
				case 'validate_max_len':
					if($param == 1) {
						$resp[] = "Поле <span class=\"$field_class\">$field</span> должно быть короче $param символа";
					} else {
						$resp[] = "Поле <span class=\"$field_class\">$field</span> должно быть короче $param символов";
					}
					break;
				case 'validate_min_len':
					if($param == 1) {
						$resp[] = "Поле <span class=\"$field_class\">$field</span> должно быть длиннее $param символа";
					} else {
						$resp[] = "Поле <span class=\"$field_class\">$field</span> должно быть длиннее $param символов";
					}
					break;
				case 'validate_exact_len':
					if($param == 1) {
						$resp[] = "Поле <span class=\"$field_class\">$field</span> должно соответствовать $param символу в длине";
					} else {
						$resp[] = "Поле <span class=\"$field_class\">$field</span> должно соответствовать $param символам в длине";
					}
					break;
				case 'validate_alpha':
					$resp[] = "Поле <span class=\"$field_class\">$field</span> может содержать только буквенные символы (а-я)";
					break;
				case 'validate_alpha_numeric':
					$resp[] = "Поле <span class=\"$field_class\">$field</span> может содержать только буквенные символы и цифры";
					break;
				case 'validate_alpha_dash':
					$resp[] = "Поле <span class=\"$field_class\">$field</span> может содержать только буквенные символы &amp; тире";
					break;
				case 'validate_numeric':
					$resp[] = "Поле <span class=\"$field_class\">$field</span> может содержать только цифры";
					break;
				case 'validate_integer':
					$resp[] = "Поле <span class=\"$field_class\">$field</span> может содержать только числовое значение";
					break;
				case 'validate_boolean':
					$resp[] = "Поле <span class=\"$field_class\">$field</span> может содержать только истинное или ложное значение";
					break;
				case 'validate_float':
					$resp[] = "Поле <span class=\"$field_class\">$field</span> может содержать только значение";
					break;
				case 'validate_valid_url':
					$resp[] = "Введите в поле <span class=\"$field_class\">$field</span> правильный URL";
					break;
				case 'validate_url_exists':
					$resp[] = "Введенный URL в поле <span class=\"$field_class\">$field</span> не существует";
					break;
				case 'validate_valid_ip':
					$resp[] = "Поле <span class=\"$field_class\">$field</span> должно содержать правильный IP-адрес";
					break;
				case 'validate_valid_cc':
					$resp[] = "Поле <span class=\"$field_class\">$field</span> должно содержать правильный номер банковской карты";
					break;
				case 'validate_valid_name':
					$resp[] = "Поле <span class=\"$field_class\">$field</span> должно содержать правильное Имя";
					break;
				case 'validate_contains':
					$resp[] = "Поле <span class=\"$field_class\">$field</span> должно содержать одно из следующих значений: ".implode(', ', $param);
					break;
				...
				case 'validate_doesNotContainList':
					$resp[] = "Поле <span class=\"$field_class\">$field</span> содержит недопустимое значение";
					break;
				case 'validate_street_address':
					$resp[] = "Поле <span class=\"$field_class\">$field</span> должно содержать правильный адрес";
					break;
				case 'validate_date':
					$resp[] = "Поле <span class=\"$field_class\">$field</span> должно содержать правильную дату";
					break;
				case 'validate_min_numeric':
					$resp[] = "Поле <span class=\"$field_class\">$field</span> должно содержать числовое значение, равное или большее чем $param";
					break;
				case 'validate_max_numeric':
					$resp[] = "Поле <span class=\"$field_class\">$field</span> должно содержать числовое значение, равное или меньшее чем $param";
					break;
